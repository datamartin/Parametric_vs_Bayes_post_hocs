shinyUI(fluidPage(
        ...
        mainPanel(
                tabsetPanel(tabPanel("Intro", 
                                     ...
                                     strong("Text about usage"),
                                     p(""),
                                     strong("1. "),
                                     span("User can upload his/her own the data or explore the app with provided example data;"),
                                     p(""),
                                     strong("2. "),
                                     span("..."),
                                     p(""),
                            ...
                            tabPanel("Example data",
                                     p("coming soon..."),"Structure of data", verbatimTextOutput("summary")),
